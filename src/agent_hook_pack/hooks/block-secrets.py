...
# Anchored to path parts â€” NOT substring â€” so workspace Python modules whose
...
try:
    ...
    # Check path component matches (anchored, not substring â€” see SENSITIVE_PATH_COMPONENTS comment).
